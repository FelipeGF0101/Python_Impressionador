...
O enumerate permite que você percorra uma lista de ao mesmo tempo tenha em uma variável o índice daquele item.
...
funcionarios = ['Maria', 'José', 'Antônio', 'João', 'Francisco', 'Ana', 'Luiz', 'Paulo', 'Carlos', 'Manoel', 'Pedro', 'Francisca', 'Marcos', 
                'Raimundo', 'Sebastião', 'Antônia', 'Marcelo', 'Jorge', 'Márcia', 'Geraldo', 'Adriana', 'Sandra', 'Luis']
...
for i, quant in enumerate(estoque):
    if quant < nivel_minimo:
        print(f'O produto {produtos[i]} está abaixo da quantidade mínima do estoque com apenas {quant} unidades.')
