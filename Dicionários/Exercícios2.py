...
dicionário = {
    ...
    produto2: (vendas2019, vendas 2020),
    produto3: (vendas2019, vendas 2020),
    ...

}

* Apesar de parecer menos prático esse é um procedimento que precisamos nos acostumar a fazer, visto que algumas
funções (tema dos próximos módulos) precisam de dicionários para funcionar e saber transformar listas em dicionários ( e vice-versa)
é uma habilidade muito útil.

OBS: Lembre do zip para juntar listas.
Obs2: Repare que cada item das vendas é na verdade uma lista. Então é provável que você precise fazer esse cógigo em 2 etapas.
