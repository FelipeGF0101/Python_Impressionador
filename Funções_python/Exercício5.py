...
Isso significa que na prática, caímos em muitos casos de ter uma lista de produtos, mas quando olhamos por exemplo uma base com a posição em estoque de cada produto,
surge nessa "base" produtos que não existiam na nossa lista inicial.
...
Vamos criar uma function que pega todas essas listas e cria, a partir dela, uma lista de produtos. Com o objetivo de saber todos os produtos que temos na empresa. 
...
"""
def listar_produtos(*args): # Criando a função com *args, possibilita várias entradas de argumentos
    lista_produtos = [] # Inicializa uma lista vazia
    for lista in args: # Para cada argumento
        for produto, estoque in lista: # Para cada item e valor de estoque dentro de cada argumento
            lista_produtos.append(produto) # Adiciona o valor desejado dentro da lista vazia
    lista_produtos = set(lista_produtos) # transforma a lista em set para retirar valores repetidos
    lista_produtos = list(lista_produtos) # tranforma em lista novamente
    return lista_produtos

stoque_fim_jan = [('BSA2199',396),('PPF5239',251),('BSA1212',989),('PPF2154',449),('BEB3410',241),('PPF8999',527),('EMB9591',601),('BSA2006',314),('EMB3604',469),('EMB2070',733),('PPF9018',339),('PPF1468',906),('BSA5819',291),('PPF8666',850),('BEB2983',353),('BEB5877',456),('PPF5008',963),('PPF3877',185),('PPF7321',163),('BSA8833',644),('PPF4980',421),('PPF3063',757),('BSA2089',271),('BSA8398',180),('EMB4622',515),('EMB9814',563),('PPF3784',229),('PPF2398',270),('BEB3211',181),('PPF8655',459),('PPF1874',799),('PPF8789',126),('PPF6324',375),('EMB9290',883),('BSA5516',555),('BSA8451',243),('BSA8213',423)]
...
print(listar_produtos(stoque_fim_jan, estoque_fim_fev, estoque_fim_mar, estoque_fim_abr))
